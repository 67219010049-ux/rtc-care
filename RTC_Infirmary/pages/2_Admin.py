...
def set_perfect_background():
    ...
    if encoded_string:
        ...
        /* 🛠️ ปรับปรุงแก้ไขช่องกรอก Input ให้เห็นตัวอักษรและตัวบอกพิมพ์ (Cursor) ได้ชัดเจน */
        div[data-baseweb="input"] {{
            background-color: #ffffff !important;
            border: 1px solid #e2e8f0 !important; /* เพิ่มเส้นบางเพื่อให้แยกแยะส่วนกรอกข้อมูลง่ายขึ้น */
            border-radius: 6px !important;
        ...
        div[data-baseweb="input"] input {{
            ...
            background-color: #ffffff !important;
            border: none !important;
            caret-color: #001f3f !important; /* บังคับสีตัวบอกพิมพ์ (Cursor) ให้เห็นชัด */
        }}
...
# 🛠️ ปรับแก้กล่องสีน้ำเงินแถบแจ้งเตือน: เปลี่ยนเป็นสีน้ำเงินพาสเทลที่สว่างและอ่อนลงสบายตากว่าเดิม ยึดดีไซน์ไร้กรอบ
