...
def set_perfect_background():
    ...
    if encoded_string:
        ...
        /* ช่องกรอก Input ให้เห็นตัวอักษรและตัวบอกพิมพ์ (Cursor) ได้ชัดเจน */
        ...
        /* เจาะจงเปลี่ยนสีปุ่ม ออกจากระบบ และ ยืนยันลบยา เป็นสีแดง */
        button[key="logout_button"], button[key="execute_delete_btn"] {{
            background-color: #dc3545 !important;
            border: none !important;
        }}
        button[key="logout_button"]:hover, button[key="execute_delete_btn"]:hover {{
...
if st.session_state.admin_logged_in:
    ...
    if df.empty:
        ...
        if not waiting_options:
            ...
            custom_yellow_box(f"📋 **เคสตรวจรักษาและสั่งยา:** {selected_student_name} | **โรคประจำตัว:** {student_info.get('โรคประจำตัว', '-')} | **แผนกวิชา:** {student_info['แผนกวิชา']} | **อาการเบื้องต้น:** {student_info['อาการเบื้องต้น']}")
