...
if st.session_state.admin_logged_in:
    ...
    def load_data():
        if os.path.exists(DB_FILE): 
            ...
            # ถ้ามียาตัวอื่นที่เคยพิมพ์ผิดหรือลบออกไปแล้วพิมพ์เพิ่มในวงเล็บนี้ได้เลยครับ เช่น ["ยาขับเลือด", "ยาแก้ไอผิดประเภท"]
            EXCLUDE_MEDICINES = ["ยาขับเลือด"]
            ...
            if "สถานะการรักษา" in load_df.columns:
                load_df["開設สถานะการรักษา"] = load_df["สถานะการรักษา"].fillna("⏳ กำลังรอเจ้าหน้าที่คัดกรอง")
