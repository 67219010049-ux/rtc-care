...
# ==========================================
# ฟังก์ชันจัดการภาพพื้นหลังอัจฉริยะ + ปรับแต่งสไตล์ (Mobile Friendly)
# ==========================================
def set_perfect_background():
    ...
    if encoded_string:
        ...
        /* 🎨 ปรับแต่งข้อความคำแนะนำ 'Press Enter...' ให้แสดงผลสวยงาม */
        ...
        /* 🚫 พอกดส่งข้อมูลสำเร็จ (ช่องอินพุตถูกล้างค่าว่าง) -> ให้ซ่อนคำแนะนำทันที */
        ...
        @media (max-width: 768px) {{
            ...
            /* 📱 ปรับขนาดคำแนะนำให้เล็กลงเป็นพิเศษสำหรับหน้าจอโทรศัพท์มือถือ */
            div[data-testid="stTextInput"] [data-testid="stWidgetInstructions"],
            .stTextInput div[data-testid="stWidgetInstructions"],
            div[data-testid="stTextInput"] small {{
