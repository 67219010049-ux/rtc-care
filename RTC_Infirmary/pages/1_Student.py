...
# ==========================================
# 🎨 ฟังก์ชันจัดการภาพพื้นหลัง + [ปรับปรุง] ระบบปรับอักษรอัตโนมัติตามมือถือ (Responsive)
# ==========================================
...
if not os.path.exists(DB_FILE):
    pd.DataFrame(columns=["วันที่-เวลา", "รหัสนักศึกษา", "ชื่อ-นามสกุล", "แผนกวิชา", "อาการเบื้องต้น", "สถานะการรักษา", "การจ่ายยา/หมายเหตุ"]).to_csv(DB_FILE, index=False, encoding="utf-8-sig")
    ...
    if submit_btn:
        if not student_id.strip() or not student_name.strip():
            ...
            new_record = {
                ...
                "สถานะการรักษา": "⏳ กำลังรอเจ้าหน้าที่ตรวจ",
                "การจ่ายยา/หมายเหตุ": "-"
            }
