...
def set_perfect_background():
    ...
    if encoded_string:
        ...
        /* 🔵 [แก้ไขจุดนี้] เปลี่ยนแถบ Header บนสุดให้เป็นสีกรมท่าเข้ม (Navy Blue) */
        ...
        /* บังคับสีตัวหนังสือ และค่าเลือกใน Selectbox ให้เป็นสีกรมท่าเข้ม ไม่เป็นสีขาว */
        .stTextInput input, 
        .stSelectbox div[data-baseweb="select"],
        .stSelectbox div[data-baseweb="select"] span,
        .stSelectbox div[data-baseweb="select"] div {{
            background-color: #f4f7fc !important; /* พื้นช่องสีฟ้าไอซ์บลูอ่อนๆ */
            color: #1a365d !important; /* ตัวหนังสือที่พิมพ์หรือเลือกเป็นน้ำเงินเข้ม */
            border-radius: 8px !important;
        }}
        ...
        /* เอฟเฟกต์ตอนเด็กคลิกพิมพ์ช่องคำตอบ */
        ...
        /* เจาะจงเปลี่ยนสีข้อความข้างในปุ่มให้เป็นสีขาว (แก้อาการสีกรมท่ากลืนกับปุ่ม) */
        .stFormSubmitButton button p,
        button[data-testid="baseButton-primary"] p {{
            color: #ffffff !important; 
        }}
        
        /* เอฟเฟกต์ตอนเมาส์ชี้ปุ่มบันทึกข้อมูล (ตัวหนังสือก็ยังคงเป็นสีขาวเด่นชัด) */
...
# ปรับข้อความประกาศให้เป็นทางการ คลีน ไม่มีสติกเกอร์
...
with st.form(key="student_form", clear_on_submit=True):
    ...
    if submit_btn:
        if not student_id.strip() or not student_name.strip():
            ...
            # ตรวจสอบค่าโรคประจำตัว ถ้าเว้นว่างให้ใส่ "-"
