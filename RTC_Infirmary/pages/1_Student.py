...
def set_perfect_background():
    ...
    if encoded_string:
        ...
        /* ซ่อนตัวนับตัวอักษรภาษาอังกฤษที่มักจะเบียดหน้าจอมือถือ */
        div[data-testid="stTextInput"] div:has( > iframe), 
        div[data-testid="stTextInput"] [style*="pointer-events"] {{
...
with st.form(key="student_form", clear_on_submit=True):
    ...
    # 1. กล่องรหัสนักศึกษา (เอาคำว่า 11 หลัก ภาษาอังกฤษออก และเคลียร์ Placeholder)
