...
# ==========================================
# ฟังก์ชันจัดการภาพพื้นหลังอัจฉริยะ (ปรับเปลี่ยนเป็นไฟล์ .jpg ตามสั่ง)
# ==========================================
def set_perfect_background():
    # เปลี่ยนการค้นหาไฟล์ภาพจาก .png เป็น .jpg เรียบร้อยครับพี่
    possible_paths = [
...
# 📥 ฟอร์มรับข้อมูลนักเรียน (คลีนสติกเกอร์ออกหมดแล้ว)
with st.form(key="student_form", clear_on_submit=True):
    ...
    if submit_btn:
        if not student_id.strip() or not student_name.strip():
            ...
            # ยิงแจ้งเตือนเข้า Telegram สไตล์เป็นทางการ ไม่มีสติกเกอร์ตามสั่งครับ
