...
# ==========================================
# ฟังก์ชันจัดการภาพพื้นหลังอัจฉริยะ (แก้ไขตำแหน่งค้นหาไฟล์แบบ Absolute Path)
# ==========================================
def set_perfect_background():
    # ดึงตำแหน่งโฟลเดอร์ปัจจุบันที่ไฟล์ Python นี้ทำงานอยู่
    base_dir = os.path.dirname(os.path.abspath(__file__))
    
    # เจาะจงหาไฟล์ที่ตำแหน่ง images/bg.jpg โดยอ้างอิงจากโฟลเดอร์หลัก
    possible_paths = [
    ...
    if encoded_string:
        ...
        /* 🛠️ [จุดแก้เพื่อมือถือ] บังคับสไตล์ในหน้าจอมือถืออย่างเด็ดขาด */
