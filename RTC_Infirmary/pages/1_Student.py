...
def set_perfect_background():
    ...
    if encoded_string:
        ...
        bg_css = f"""
        <style>
        /* 🛠️ จุดแก้ไข: เจาะจงคลาส container ด้านในสุดทั้งหมดของ Streamlit เพื่อไม่ให้แท็กอื่นมาถมสีกระดาษทับ */
        ...
        [data-testid="stAppViewMain"], [data-testid="stMain"] {{
...
with st.form(key="student_form", clear_on_submit=True):
    ...
    # ==========================================
    # 🔥 ลอจิกตรวจสอบเงื่อนไขคงเดิมตามของน้องทั้งหมด
    # ==========================================
    if submit_btn:
