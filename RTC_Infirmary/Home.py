...
st.set_page_config(page_title="RYTC Infirmary - Home", page_icon="🏥", layout="wide")
...
def set_perfect_background(image_path):
    try:
        ...
        /* 🎯 เลือกคุมเฉพาะส่วนเนื้อหาข้อความที่เป็นข้อมูล ไม่คลุมโครงสร้างระบบหลักเพื่อป้องกันลูกศรบัค */
        ...
        /* 📱 4. บังคับและล็อกสีข้อความส่วนหัวให้อ่านง่าย คมชัด และใช้ฟอนต์ IBM Plex Sans Thai */
        .responsive-h1 {{
            text-align: center; 
...
# ==========================================
# 📦 กล่องข้อความ HTML Component (เปลี่ยน Font เป็น IBM Plex Sans Thai)
# ==========================================
html_display = """
<!DOCTYPE html>
<html>
