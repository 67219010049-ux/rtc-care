...
def set_perfect_background(image_path):
    try:
        ...
        bg_css = f"""
        <style>
        /* 1. เปลี่ยนแถบบนสุดของ Streamlit เป็นสีน้ำเงินกรมท่าแบบเป็นทางการ */
        ...
        /* เปลี่ยนสีไอคอน/ปุ่มเมนูบนแถบสีน้ำเงินให้เป็นสีขาว จะได้มองเห็นชัดเจน */
...
# 🛠️ จุดที่แก้ไข: ใช้ os.path เพื่อคำนวณตำแหน่งโฟลเดอร์ให้แม่นยำ ไม่ว่ารันที่คอมหรือบนเว็บ Cloud
